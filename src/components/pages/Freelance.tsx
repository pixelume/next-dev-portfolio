...
export function Freelance() {
  return (
    <>
      <div className="bg-gradient-to-r from-cyan-500 to-blue-500 w-full flex sm:items-stretch md:items-center justify-center min-h-screen relative snap-start snap-always pb-6 md:pb-0">
        <AnimatingParagraphs className="p-4 md:w-1/2 sm:h-screen md:h-full justify-around" autoTrigger={false} showScroll>
          <div className="flex items-center gap-x-2 border-b border-slate-50 pb-3">
            ...
            <div className="text-2xl md:text-4xl">
              Work Experience
              <br />
              <span className="text-lg md:text-2xl">July 2018 - Present</span>
            </div>
          </div>
          <div className="flex justify-center items-center w-full gap-x-5">
            <Image alt="Freelance" src='/freelance.webp' width={64} height={64} />
            <div className="text-lg md:text-2xl">Freelance - Frontend React Developer</div>
          </div>
          <div className="text-md md:text-2xl text-left">
            Successfully completed various front-end, JAMstack, and serverless projects as a freelance front-end React
            developer.
          </div>
        </AnimatingParagraphs>
      </div>
